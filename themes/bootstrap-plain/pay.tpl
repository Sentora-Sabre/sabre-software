	<div style="width:960px;margin: 0 auto;">
		<div style="float:right;width:200px;height:105px" class="box">
			<h2>Your order</h2>
			<span style="font-size:18px;font-weight:bold;">{{package_name}}</span><br />
			{{period}} month <span style="float:right">{{pay}}</span><br />
			</hr>
			<b>Total price</b> <span style="float:right;">{{pay}}</span>
		</div>
